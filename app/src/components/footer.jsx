export default function Footer() {
  return (
    <div className="bg-gradient-to-r from-pink-200  to-purple-200 h-52 mt-10">
      <p className="text-3xl font-bold text-center logo pt-8">Dreel.ai</p>

      <p className="text-center mt-2  text-sm">connect with us</p>
      <div className="mt-4 mx-auto flex w-56 justify-between scale-75">
        <a
          className="block"
          target="_blank"
